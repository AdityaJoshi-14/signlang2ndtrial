...
print(classification_report(y_test, y_pred, target_names=['Not Thanks', 'Thanks']))

# -------- CONFUSION MATRIX -------- #
cm = confusion_matrix(y_test, y_pred)
sns.heatmap(cm, annot=True, cmap='Blues', fmt='g', xticklabels=['Not Thanks', 'Thanks'], yticklabels=['Not Thanks', 'Thanks'])
