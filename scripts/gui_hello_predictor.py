...
# -------- CONFIG -------- #
MODEL_PATH = 'models/hello_model.keras'
SEQUENCE_LENGTH = 30
THRESHOLD = 0.7
# ------------------------ #
...
# GUI Application
class HelloPredictorApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Hello Sign Detector")
        self.running = False
        self.sequence = []
        ...
        with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
            while self.running and self.cap.isOpened():
                ...
                if len(self.sequence) == SEQUENCE_LENGTH:
                    ...
                    label = "Hello" if avg_pred > THRESHOLD else "Not Hello"
