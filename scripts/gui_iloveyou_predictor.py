...
# -------- CONFIG -------- #
MODEL_PATH = 'models/iloveyou_model.keras'
SEQUENCE_LENGTH = 30
THRESHOLD = 0.7
# ------------------------ #
...
print("✅ Loaded model: iloveyou_model.keras")
...
# GUI Application
class IloveyouPredictorApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Iloveyou Sign Detector")
        self.running = False
        self.sequence = []
        ...
        with mp_holistic.Holistic(min_detection_confidence=0.5, min_tracking_confidence=0.5) as holistic:
            while self.running and self.cap.isOpened():
                ...
                if len(self.sequence) == SEQUENCE_LENGTH:
                    ...
                    label = "Iloveyou" if avg_pred > THRESHOLD else "Not Iloveyou"
